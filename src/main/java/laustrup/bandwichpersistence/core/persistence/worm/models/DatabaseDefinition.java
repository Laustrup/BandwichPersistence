...
public interface DatabaseDefinition {
  ...
  record Conjunction(Entity target, Entity common, Entity... relations) implements DatabaseDefinition {

    public static Conjunction of(Class<?> target, Class<?> common, Class<?>... relations) {
      if (target == null || common == null || Arrays.stream(relations).anyMatch(Objects::isNull))
        throw new IllegalArgumentException("Neither target, common nor any relations class is allowed to be null!");
