...
import static laustrup.bandwichpersistence.core.persistence.worm.services.DatabaseTableService.defineColumnTitle;
...
public abstract class DatabaseDefinitionService {
    ...
    public static String getIdReference(Class<?> entity) {
        ...
        return defineColumnTitle(ifNotEmpty(idReference)
                .otherwise(String.join("_", getTableTitle(entity), "id"))
        );
    }
