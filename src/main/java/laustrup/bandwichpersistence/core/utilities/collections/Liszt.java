...
public class Liszt<E> extends Coollection<E> implements ILiszt<E>, List<E>, ICoollection<E> {
  ...
  public boolean isEmpty() {
    return _data.length == 0 && _map.isEmpty();
  }
  ...
  public Iterator<E> iterator() {
    return Arrays.stream(_data).iterator();
  }
  ...
  public Object[] toArray() {
    return Arrays.stream(_data).toArray();
  }

  @Override
  @SuppressWarnings("unchecked")
  public <T> T[] toArray(T[] a) {
    return (T[]) Arrays.stream(_data).toArray();
  }

  @Override
  @SuppressWarnings("unchecked")
  public <T> T[] toArray(IntFunction<T[]> generator) {
    return (T[]) List.super.toArray(Object[]::new);
  }
  ...
  public ListIterator<E> listIterator() {
    return Arrays.stream(_data).toList().listIterator();
  }

  @Override
  public ListIterator<E> listIterator(int index) {
    return Arrays.stream(_data).toList().listIterator(index);
  }

  public List<E> SubList(int min, int max) {
    return subList(min - 1, max - 1);
  }

  @Override
  public List<E> subList(int min, int max) {
    return Arrays.stream(subArray(min, max)).toList();
  }

  public Liszt<E> SubLiszt(int min, int max) {
    return subLiszt(min - 1, max - 1);
  }

  public Liszt<E> subLiszt(int min, int max) {
    return new Liszt<>(subArray(min, max));
  }

  public E[] SubArray(int min, int max) {
    return subArray(min - 1, max - 1);
  }
